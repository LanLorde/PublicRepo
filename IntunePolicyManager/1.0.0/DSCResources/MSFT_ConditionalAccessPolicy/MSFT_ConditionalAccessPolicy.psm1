...
function Test-TargetResource {
    ...
    $existing = Get-MgConditionalAccessPolicy | Where-Object { $_.DisplayName -eq $policy.displayName }
...
function Set-TargetResource {
    ...
    if ($existing) {
        ...
        Update-MgConditionalAccessPolicy -ConditionalAccessPolicyId $existing.Id -BodyParameter $policy
        ...
        [PSCustomObject]@{
            Timestamp    = $timestamp
            ResourceType = 'MSFT_ConditionalAccessPolicy'
